...
#include <lmic.h>
#include <hal/hal.h>
const unsigned  TX_INTERVAL = 150;  // previously tested with 300=5 minutes; 15 hours battery time but many gps losses // transmit interval, 5 minutes is healthy according to TTN rules; however 60 sec is still very well possible (risk is getting the device blacklisted rest of day)
